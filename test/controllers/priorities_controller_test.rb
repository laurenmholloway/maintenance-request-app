...
class PrioritiesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create priority" do
    assert_difference('Priority.count') do
      post priorities_url, params: { priority: { has_many: @priority.has_many, level: @priority.level } }
    end
  ...
  test "should update priority" do
    patch priority_url(@priority), params: { priority: { has_many: @priority.has_many, level: @priority.level } }
