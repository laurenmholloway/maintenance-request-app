...
class RequestsTest < ApplicationSystemTestCase
  ...
  test "creating a Request" do
    ...
    fill_in "Details", with: @request.details
    fill_in "Headline", with: @request.headline
    fill_in "Permissiontoenter", with: @request.permissionToEnter
    fill_in "Requestdatetime", with: @request.requestDateTime
